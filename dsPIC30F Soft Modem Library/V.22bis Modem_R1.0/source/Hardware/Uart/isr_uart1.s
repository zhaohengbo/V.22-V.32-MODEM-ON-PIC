...
;  GetString                                                                  *
;  ======================                                                     *
;  Description: This function stores the string char by char to OutDataBuf.   *
;  ======================                                                     *
;  Input:                                                                     *
;        void                                                                 *
;  Output:                                                                    *
...
;     U1RXInterrupt:                   32                                     *
;     SendCharToUARTTx:                37                                     * 
;     GetString:                       Depends on String Len                  *
;*****************************************************************************/
...
; -----------------------------------------------------------------------------
; DESCRIPTION:   This function is used to store the string in Out Data Buffer.
; -----------------------------------------------------------------------------
...
GET_NEXT_CHAR:
    ...
    tblrdl.b   [w3++], w2          ;Get the character from the buffer
    cp0.b      w2
    bra        z,EXIT_GET_STRING

    mov.b  w2,[w1++]               ;Update the character into the o/p buffer
...
_GetSMString:
    ...
    sl         w1,#1,w1
    add        w0,w1,w0
    tblrdl.w   [w0], w1           ;Get the index from the buffer
...
GET_NEXT_SM_CHAR:
    ...
    tblrdl.b   [w4++], w2          ;Get the character from the buffer
    cp0.b      w2
    bra        z,EXIT_GET_SM_STRING

    mov.b  w2,[w3++]               ;Update the character into the o/p buffer

    inc   w0, w0
    bra    GET_NEXT_SM_CHAR
